...
void Vcounter_async___024root__trace_chg_sub_0(Vcounter_async___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vcounter_async___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_async___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vcounter_async___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vcounter_async___024root__trace_chg_sub_0(Vcounter_async___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vcounter_async__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_async___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vcounter_async___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_async___024root__trace_cleanup\n"); );
    // Init
    Vcounter_async___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vcounter_async___024root*>(voidSelf);
    Vcounter_async__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
