...
VL_INLINE_OPT void Vcounter_async___024root___sequent__TOP__0(Vcounter_async___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcounter_async__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_async___024root___sequent__TOP__0\n"); );
    // Body
...
void Vcounter_async___024root___eval(Vcounter_async___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcounter_async__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_async___024root___eval\n"); );
    // Body
    if ((((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk))) 
         | ((IData)(vlSelf->rst) & (~ (IData)(vlSelf->__Vclklast__TOP__rst))))) {
        Vcounter_async___024root___sequent__TOP__0(vlSelf);
    }
    // Final
...
void Vcounter_async___024root___eval_debug_assertions(Vcounter_async___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcounter_async__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_async___024root___eval_debug_assertions\n"); );
    // Body
